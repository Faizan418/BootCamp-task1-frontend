      ...
      >
        ...
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-white tracking-tight">Income Entry</h2>
              <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em]">Financial Inflow Management</p>
            </div>
          </div>
          <button
...
>
  ...
  <X className="relative z-10 w-5 h-5 group-hover:rotate-90 transition-transform duration-300" />
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="space-y-3">
             ...
             <div className="relative group overflow-hidden rounded-3xl bg-white/[0.03] border border-white/5 focus-within:border-emerald-500/40 transition-all">
                <div className="flex items-center px-6 py-4">
                  <span className="text-2xl font-black text-emerald-500 mr-4">Rs.</span>
                  <input
                    type="number"
                    placeholder="0.00"
                    value={amount}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 text-center md:text-left">Select Category Icon</label>
            ...
            <div className="space-y-5">
               <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Source Name</label>
        ...
        <div className="mt-12">
          ...
          <p className="text-center text-[9px] text-slate-600 mt-4 uppercase font-bold tracking-[0.2em]">Securely encrypted transaction</p>
        </div>
      </form>
    </motion.div>
  );
