...
export default function Expenses() {
  ...
  // Expense oriented color palette (Rose/Pink/Orange)
  ...
  return (
    // <div className="min-h-screen bg-[#020617] text-slate-200 p-4 md:p-8 selection:bg-rose-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                <p className="text-rose-400 font-black text-xs uppercase tracking-[0.3em] mb-1">Total Spending (Filtered)</p>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center bg-white/[0.02] border border-white/5 p-4 rounded-3xl backdrop-blur-md">
          <div className="relative flex-1 group w-full">
            ...
            <input
              ...
              className="w-full bg-transparent border border-white/10 rounded-2xl pl-12 pr-4 py-3 outline-none focus:ring-2 ring-rose-500/20 transition-all text-sm font-medium"
            />
          </div>
          <div className="flex gap-3 w-full lg:w-auto">
            <select
              ...
              className="flex-1 lg:w-48 bg-slate-900 border border-white/10 rounded-2xl px-4 py-3 text-sm font-bold cursor-pointer outline-none hover:bg-slate-800 transition-colors appearance-none"
            >
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-8 sticky top-10 shadow-2xl">
               ...
               <div className="h-72 relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none w-full">
                  ...
                  <p className="text-xl font-black text-white leading-none mt-1 px-4 truncate">
               ...
               <div className="mt-10 space-y-3 max-h-60 overflow-y-auto custom-scrollbar pr-1">
                  {chartData.map((c) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-black text-white">${c.value.toLocaleString()}</span>
                    </button>
                  ))}
               </div>
            </div>
              ...
              <AnimatePresence mode="popLayout">
                {filteredExpenses.map((t, index) => (
                  <motion.div
                    ...
                    className="group bg-white/[0.03] border border-white/5 hover:border-rose-500/40 p-6 rounded-[2rem] flex flex-col justify-between transition-all hover:bg-white/[0.06] hover:shadow-2xl shadow-rose-500/5"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h5 className="font-black text-white group-hover:text-rose-400 transition-colors">{t.category}</h5>
